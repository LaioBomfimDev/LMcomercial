        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15554.123456789!2d-38.324167!3d-12.697222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDQxJzUwLjAiUyAzOMKwMTknMjcuMCJX!5e0!3m2!1spt-BR!2sbr!4v1234567890123"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    <a href="tel:+5571999999999" className="hover:text-dark-blue transition-colors">
                      (71) 99999-9999
                    </a>
                  </p>
                </div>
